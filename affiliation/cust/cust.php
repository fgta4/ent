...
if (is_file(__DIR__ .'/cust.php-handler.php')) {
	require_once __DIR__ .'/cust.php-handler.php';
}

/**
 * ent/affiliation/cust/cust.php
 *
 * ===================================================================
 ...
 * awal dibuat tanggal 05/10/2024
 * terakhir di generate tanggal 27/11/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\cust_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new cust_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
